 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/ticket_registration/{ticket_registration}",
 *     "add-page" = "/admin/structure/ticket_registration/add",
 *     "add-form" = "/admin/structure/ticket_registration/add/{ticket_registration_type}",
 *     "edit-form" = "/admin/structure/ticket_registration/{ticket_registration}/edit",
 *     "delete-form" = "/admin/structure/ticket_registration/{ticket_registration}/delete",
 *     "collection" = "/admin/structure/ticket_registration",
 *   },
