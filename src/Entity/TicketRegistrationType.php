 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/ticket_registration_type/{ticket_registration_type}",
 *     "add-form" = "/admin/structure/ticket_registration_type/add",
 *     "edit-form" = "/admin/structure/ticket_registration_type/{ticket_registration_type}/edit",
 *     "delete-form" = "/admin/structure/ticket_registration_type/{ticket_registration_type}/delete",
 *     "collection" = "/admin/structure/ticket_registration_type"
 *   }
 * )
 */
